...
<div class="grid__container">
    ...
    &nbsp;
    <form>
    <select id="region" onclick="sendGetRequest('Assets/Servers--FIWARE.php?region='+this.value, 'grid1', 'grid1');">
      <?php    
      session_start();  
          $json = json_decode($_SESSION['nodes'], true);
    ...
    <div class="menu">
        <li><input type="button" value="Instances&#x27a1;" onclick="sendGetRequest('Assets/Servers--FIWARE.php?region='+document.getElementById('region').value, 'grid1', 'grid1');"></li>
        <li><input type="button" value="Images&#x27a1;" onclick="sendGetRequest('Assets/Images--FIWARE.php', 'grid1', 'grid1');"></li>
    </div>
</div>
