...
<div class="grid__container">
  ...
  <img src="http://cloud.intellicloud.tuc.gr/images/logo.png" height="60" width="210">
  <br>
...
<div class="skip">
  <input type="button" value="Fiware" onclick="window.location='procedure.php';">  
  <input type="button" value="Skip Step&#x27a1;" onclick="window.location='upload-proc.php';">  
</div>

<div class="description">  
  <center><h3>Log in with intellicloud credentials to start the download procedure.</h3></center>
</div>
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  ...
  header("location: intellicloud-download.php");
